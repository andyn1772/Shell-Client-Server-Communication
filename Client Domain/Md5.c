 ...
 */
static void MDPrint (mdContext, mystring)
MD5_CTX *mdContext;
char *mystring;
{
  int i;
  for (i = 0; i < 16; i++)
    snprintf (mystring, 1024, "%s%02x", mystring, mdContext->digest[i]);
}
...
/* Computes the message digest for a specified file.
   ...
   return.
 */
static void MDFile (filename, mystring)
char *filename;
char *mystring;
{
